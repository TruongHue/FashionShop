    ...
    public class SeedData
    {
        ...
        public static void SeedingData(DataContext _context)
        {
            ...
            if (!_context.SanPhams.Any())
            {
                ...
                DanhMucModel Ao = new DanhMucModel { Name = "ao", Slug = "ao", Description = "Áo hot trend", Status = 1 };
                DanhMucModel Quan = new DanhMucModel { Name = "quan", Slug = "quan", Description = "quần hot tren", Status = 1 };
				DanhMucModel Tui = new DanhMucModel { Name = "tui", Slug = "tui", Description = "túi hot tren", Status = 1 };

				_context.SanPhams.AddRange(

                    new SanPhamModel { Name = "áo", Slug = "áo", Description = "Mẫu áo thun thịnh hành nhất 2024", Price = 1000, DanhMuc = Ao, ThuongHieu = LouisVuitton, Image = "1.jpg" },
                    new SanPhamModel { Name = "quần", Slug = "quần", Description = "Mẫu quần thun thịnh hành nhất 2024", Price = 500, DanhMuc = Quan, ThuongHieu = Zara, Image = "1.jpg" },
					new SanPhamModel { Name = "túi", Slug = "túi", Description = "Mẫu túi thịnh hành nhất 2024", Price = 500, DanhMuc = Tui, ThuongHieu = Zara, Image = "1.jpg" }
